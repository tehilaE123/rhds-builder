...
console.log("closeIcon loaded:", closeIcon);

RhIcon.resolve = (set, name) => {
  console.log("Resolving icon:", { set, name });
  if (name.includes("close")) {
    console.log("Returning close icon");
    return closeIcon.content.cloneNode(true);
  }
  console.log("Icon not found:", name, set);
  return null;
};
...
export { RhFooterCopyright } from "@rhds/elements/rh-footer/rh-footer-copyright.js";
